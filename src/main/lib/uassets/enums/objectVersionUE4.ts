...
export const UAssetObjectVersionUE4 = {
    ...
    VER_UE4_SAVE_COLLISIONRESPONSE_PER_CHANNEL: {
        value: 255,
        comment:
            "@note!!! once we pass this CL, we can rename FCollisionResponseContainer enum values. we should rename to match ECollisionChannel",
    },
    ...
    VER_UE4_FIX_BLUEPRINT_VARIABLE_FLAGS: {
        value: 359,
        comment: "Fix some blueprint variables that have the CPF_DisableEditOnTemplate flag set when they shouldn't",
    },
